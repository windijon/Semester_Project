...
Core result of the question answered: which is the most active / laziest wildboar and most adventurous wild boar. The interpretation is still a vage idea of what "active" / "laziest" means but in thsi project we defined it as the most active wildboar over a certain timeperiod. The results show clear "winners" and "loosers" when having a look on the mean_speed and mean_net_displacement over the evaluated timeperiod. We interpreted the results in the way that in our point of view the wildboar with the highest steplength, speed or netto displacement got evaluated as the most active wild boar and vice versa. In order to backup that we also derived the overall mean speed and netdisplacement of the individuals in order back up our hypothesis and therefore finding the most adventurous wild boar.
